...
{
    [Fact]
    public async Task Should_Persist_Guid_Values_On_SqlServer()
    {
    ...
    [Fact]
    public async Task Should_Persist_Guid_Values_On_Sqlite()
    {
    ...
    [Fact]
    public async Task Should_Not_Sort_Guids_On_SqlServer()
    {
        using var dbContext = SqlServerTestDbContextActivator.Create<TestDbContext>();
    ...
    [Fact]
    public async Task Should_Sort_Guids_On_Sqlite()
    {
        using var dbContext = SqliteTestDbContextActivator.Create<TestDbContext>();
    ...
    [Fact]
    public async Task Should_Sort_Binary_Guids_On_SqlServer()
    {
        using var dbContext = SqlServerTestDbContextActivator.Create<TestDbContext>();
    ...
    [Fact]
    public async Task Should_Sort_Binary_Guids_On_Sqlite()
    {
        using var dbContext = SqliteTestDbContextActivator.Create<TestDbContext>();
    ...
    [Fact]
    public async Task Should_Sort_String_Guids_On_SqlServer()
    {
        using var dbContext = SqlServerTestDbContextActivator.Create<TestDbContext>();
    ...
    [Fact]
    public async Task Should_Sort_String_Guids_On_Sqlite()
    {
        using var dbContext = SqliteTestDbContextActivator.Create<TestDbContext>();
    ...
    [Fact]
    public async Task Should_Sort_Sql_Server_Guids_On_SqlServer()
    {
        using var dbContext = SqlServerTestDbContextActivator.Create<TestDbContext>();
    ...
    [Fact]
    public async Task Should_Not_Sort_Sql_Server_Guids_On_Sqlite()
    {
        using var dbContext = SqliteTestDbContextActivator.Create<TestDbContext>();
